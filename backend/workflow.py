...
YOLO_TO_DEFECT = {
    ...
    # aliases from other classifiers and models
...
REASONING_TEMPLATES = {
    "air_bubble": {
        ...
        "short": "Air turbulence can splatter paste across neighboring pads.",
        "open_circuit": "Trapped air bubble interrupts continuity during deposition.",
        "missing_hole": "Low probability for tooling hole omission.",
        "mouse_bite": "Low correlation with board edge breakout.",
        "spur": "Entrained air can cause spatter tails or irregular fringe.",
        "spurious_copper": "Secondary contributor to localized resist pinholes.",
    ...
    "nozzle_blockage": {
        ...
        "short": "Clog deflection can redirect paste string to adjacent conductor.",
        "open_circuit": "Blocked nozzle directly starves the trace/pad of material.",
        "missing_hole": "Not applicable to drilling/routing operations.",
        "mouse_bite": "Not applicable to substrate routing.",
        "spur": "Clogged tip deflection leaves tail spurs on deposit edges.",
        "spurious_copper": "Indirect; inspection of fluid channel recommended.",
    ...
    "viscosity_change": {
        ...
        "short": "Low paste viscosity causes severe slumping and bridging between pads.",
        "open_circuit": "Overly viscous paste fails to bridge trace gaps or adhere to pad.",
        "missing_hole": "Not directly related to substrate hole drilling.",
        "mouse_bite": "Secondary factor in chemical etch resist adherence.",
        "spur": "Thinned paste or resist seepage causes copper/paste spurs.",
        "spurious_copper": "Resist viscosity thinning permits localized copper etching artifacts.",
    ...
    "incorrect_parameter": {
        ...
        "short": "Excessive dispense pressure, time, or exposure aperture creates bridges.",
        "open_circuit": "Under-exposure or insufficient dispense time causes discontinuities.",
        "missing_hole": "Incorrect CNC drilling recipe or missing XY coordinate.",
        "mouse_bite": "Excessive routing feed rate or incorrect spindle RPM.",
        "spur": "Improper retract profile or phototool exposure bleed leaves spurs.",
        "spurious_copper": "Over-exposure or incomplete wash cycle leaves residual copper islands.",
    ...
    "equipment_wear": {
        ...
        "short": "Regulator drift or valve seal leak causes excess material deposition.",
        "open_circuit": "Worn fluid pump or mechanical backlash drops trace connection.",
        "missing_hole": "Broken drill bit or tool wear sensor failure during hole cycle.",
        "mouse_bite": "Dull routing bit or guide plate wear causes edge breakout tear.",
        "spur": "Worn nozzle or router tool vibration creates jagged spur contours.",
        "spurious_copper": "Degraded filtration or etching tank pump wear allows copper debris.",
